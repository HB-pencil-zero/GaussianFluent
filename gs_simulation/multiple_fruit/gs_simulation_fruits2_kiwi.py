    ...
    for k in range(len(biases)):
        ...
        for frame in tqdm(range(frame_num)):
            ...
            current_camera = get_camera_view(
                ...
                center_view_world_space= viewpoint_center_worldspace,   #np.array([2, 1 , -1.2]),   #np.array([ 1.0150,  3.9929, -1.1834]),
            ...
            if args.render_img:
                ...
                # pos_, cov3D_, rot_, opacity_, shs_ = load_and_concat_prop_dict("gs_simulation/multiple_fruit/save_tensor/watermelon.pt", pos_, cov3D_, rot_, opacity_, shs_, [1.2,3.5,-1.2])

                pos_ = torch.concat([pos  + torch.Tensor([1.2,3.5,-1.2]).cuda(), pos2],dim =0 ) 
